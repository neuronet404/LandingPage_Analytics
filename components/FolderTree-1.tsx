...
const FolderTree = () => {
  ...
  const handleFileClick = (id: string,fileType) => {
  ...
  if (loading) {
    ...
    return (
      <div className="w-20 bg-white h-screen border-r p-4 flex items-center justify-center">
        Loading...
      </div>
    );
  }
  ...
  return (
    <>
      ...
      {/* Folder & Files list */}
      <div className="w-full overflow-auto h-[60%] remove-scrollbar pb-[10%]">
        <div className="p-3">
          {folders.map((folder) => (
            <div key={folder.id}>
              <div
              ...
              >
                {folder.files.map((file) => (
                  <div
                    ...
                    onClick={()=>{handleFileClick(file.id,file.fileType)}}
                  >
